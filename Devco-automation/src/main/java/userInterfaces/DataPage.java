...
public class DataPage extends PageObject {
    ...
    public static final Target INPUT_EMAIL = Target.the("Input last name").located(By.xpath("//div[@data-component='bp/personal-details-form/email']/input[@name='email']"));
    public static final Target INPUT_EMAIL_CONFIRM = Target.the("Input last name").located(By.xpath("//div[@data-component='bp/personal-details-form/email-confirm']/input[@name='email_confirm']"));
    public static final Target BUTTON_NEXT = Target.the("Input last name").located(By.xpath("//div[@class='bui-group bui-spacer--large']/div/div[2]/button[@type='submit' and @name='book']"));
